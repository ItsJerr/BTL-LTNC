...
void ChangeMode(int ModeID, void* Data = nullptr) {
    ...
    switch (ModeID) {
        ...
        case SELECTIONID: {
            CurrentLayer = new chooseCharacterLayer();
            break;
        }
        case INGAMEID :{
            CurrentLayer = new gamePlayLayer();
            break;
        }
    }
    CURRENTMODE = ModeID;
...
void Init() {
    ...
    smallGFont = TTF_OpenFont("assets/fonts/dotty.ttf", 40);
